...
CREATE TABLE IF NOT EXISTS tfa_secrets (
  ...
  qr_code TEXT NULL,
  CONSTRAINT fk_tfa_secrets_user
    FOREIGN KEY (user_id) REFERENCES users(user_id)
    ON DELETE CASCADE
);
...
ALTER TABLE activity_logs
  ADD COLUMN IF NOT EXISTS user_email VARCHAR(255) NULL AFTER log_id;

-- ============================================================
-- Blog notifications
-- ============================================================
ALTER TABLE blog_notifications
  ADD COLUMN IF NOT EXISTS recipient_id CHAR(36) NULL AFTER id;

-- ============================================================
-- Booking
-- ============================================================
ALTER TABLE booking
  ADD COLUMN IF NOT EXISTS host_id CHAR(36) NULL AFTER user_id,
  ADD COLUMN IF NOT EXISTS pdf_path VARCHAR(500) NULL AFTER refund_amount;
...
ALTER TABLE conversation
  ADD COLUMN IF NOT EXISTS context_type VARCHAR(50) NULL AFTER type,
  ADD COLUMN IF NOT EXISTS context_id BIGINT NULL AFTER context_type,
  ADD COLUMN IF NOT EXISTS last_message_id BIGINT NULL AFTER last_activity,
  ADD COLUMN IF NOT EXISTS mute_notifications TINYINT(1) NOT NULL DEFAULT 0 AFTER is_pinned;

-- ============================================================
-- Events
-- ============================================================
ALTER TABLE events
  ADD COLUMN IF NOT EXISTS id_activite INT NULL AFTER id,
  ADD COLUMN IF NOT EXISTS description LONGTEXT NULL AFTER id_activite,
  ADD COLUMN IF NOT EXISTS image VARCHAR(255) NULL AFTER materiels_necessaires,
  ADD COLUMN IF NOT EXISTS video_youtube VARCHAR(255) NULL AFTER image,
  ADD COLUMN IF NOT EXISTS statut VARCHAR(50) NULL AFTER status;
