...
public class EventsGeminiService {
    // Your API key
    private static final String API_KEY = "AIzaSyBaIyngyp25AXM0WkKQTTqXYtloIs6woOU";
    ...
    public String generateResponse(String prompt) {
        try {
            System.out.println("📤 Sending to Gemini (Events): " + prompt);
